...
\begin{dem}
    ...
    \comm{terminar de escribir esto, hacer la cadena de implicaciones para concluir que $M$ es metrizable y así poder usar que tengo los entornos disjuntos.}
\end{dem}
...
\begin{teo}{Invariancia del dominio:}
