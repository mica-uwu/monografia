...
\begin{dem}
    ...
    Por la hipótesis de inducción, sabemos que $H_{i+1}(\s^n-h(\s^{k-1}))$ es $\Z$ si $i + 1 = n- (k-1) -1$ y $0$ en cualquier otro caso. Con esto tenemos el resultado buscado para $H_{i}(\s^n-h(\s^{k}))$.
