...
\comm{obviamente $k\leq n$, esto usa invariancia del dominio, q todo encaje va a cumplir $k\leq n$. voy a agregar esto después como una observación}
...
Usando este resultado, podemos también caracterizar los grupos de homología del complemento de una esfera encajada en otra esfera de dimensión superior.
    ...
    Concluimos que no existe ningún $x\in\s^{n-1}-\partial A$, y por lo tanto, como ya teníamos la otra inclusión, obtenemos que $\s^{n-1}=\partial A$.
