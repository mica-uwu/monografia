...
Usando este resultado, podemos también caracterizar los grupos de homología del complemento de una esfera encajada en otra esfera de dimensión superior.
    ...
    \begin{proof}
    Sabemos que $A$ y $B$ son abiertos disjuntos, y como $\s^n = h(\s^{n-1}) \cup A \cup B$, necesariamente el borde de $A$ y $B$ tiene que estar contenido en el cerrado $h(\s^{n-1})$. Veamos que todo punto en $h(\s^{n-1})$ es borde de $A$ y $B$. Sin pérdida de generalidad nos restringimos al caso de la componente $A$.
