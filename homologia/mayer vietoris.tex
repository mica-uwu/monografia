...
\begin{lema}{Lema de la serpiente}
	...
	\begin{figure}[h!]
    	\centering
    	\includegraphics[width=0.75\linewidth]{img mono/mayer vietoris/serpiente.png}
    	\caption{los conjuntos van sin el \textbullet, es que copié la imagen del diagrama de otro lado. tengo que hacerlo en tikz }
    	\label{serpiente}
	\end{figure}
