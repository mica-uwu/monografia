...
$
\begin{itemize}
    \item \text{separacion de jb -> 2 cc bolas homologicas, pueden no ser variedades topológicas}
    \item \text{schoenflies (1970) -> bolas homotopicas si ..}
    \item \text{conjunto de puntos no loc planos}
\end{itemize}
$
